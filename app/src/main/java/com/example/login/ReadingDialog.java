...
public class ReadingDialog extends AppCompatActivity implements ChangeBookInfoDialog.ChangeBookInfoDialogInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ReadingDialog.this, ReadingLibraryActivity.class);
        ...
        del.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseRef.child("ReadingBook").child(firebaseUser.getUid()).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        DatabaseRef.child("ReadingBook").child(firebaseUser.getUid()).child(date.get(datelist.indexOf(temp_bookname))).removeValue();
                        Toast.makeText(ReadingDialog.this, "삭제되었습니다.", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(ReadingDialog.this, ReadingLibraryActivity.class);
                        startActivity(intent);
                        finish();
                    }
    ...
    public void applyTexts(String str_bookname, String str_author, String str_punisher, String str_punishdate, String str_genre, String str_bookreview) {
        ...
        if (str_bookname.toString()==""||str_author.toString()=="" ||str_punisher.toString()==""||str_punishdate.toString()==""||str_bookreview.toString()==""){
            ...
            Toast.makeText(ReadingDialog.this, "빈칸을 입력하세요", Toast.LENGTH_SHORT).show();
        }
            ...
            DatabaseRef.child("ReadingBook").child(firebaseUser.getUid()).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    DatabaseRef.child("ReadingBook").child(firebaseUser.getUid()).child(date.get(datelist.indexOf(temp_bookname)).toString()).setValue(bookinfo);

                    Toast.makeText(ReadingDialog.this, "도서 정보가 변경되었습니다", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ReadingDialog.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }
                @Override
