...
public class ReadingBookRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ReadingBookRegisterActivity.this, LibraryActivity.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (strbookname.length() == 0 || strauthor.length() == 0 || strpunisher.length()==0||strpunishdate.length()==0) {
                    Toast.makeText(ReadingBookRegisterActivity.this, "입력해주세요", Toast.LENGTH_SHORT).show();
                }
                else{
                    DatabaseRef.child("ReadingBook").child(firebaseUser.getUid()).child(strtime).setValue(bookinfo);
                    datelist.add(strtime);
                    UserBook.add(bookinfo);
                    Toast.makeText(ReadingBookRegisterActivity.this, "입력완료", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ReadingBookRegisterActivity.this, ReadingLibraryActivity.class);
                    startActivity(intent);
                }
            }
        });
