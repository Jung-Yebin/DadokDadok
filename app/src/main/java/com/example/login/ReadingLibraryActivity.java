...
public class ReadingLibraryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home = findViewById(R.id.btn_readingtohome);
        register_book = findViewById(R.id.btn_readingbook_register);
        ...
        list = (ListView)findViewById(R.id.readinglist);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        Intent intent = new Intent(ReadingLibraryActivity.this, ReadingDialog.class);
        ...
        register_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ReadingLibraryActivity.this, ReadingBookRegisterActivity.class);
                startActivity(intent);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ReadingLibraryActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
